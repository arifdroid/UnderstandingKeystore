...
public class Encryptor {
    ...
    byte[] encryptText(final String alias, final String textToEncrypt)
        ...
        iv = cipher.getIV();    //need to understand what is getIV
    ...
    private SecretKey getSecretKey(final String alias) throws  NoSuchAlgorithmException, NoSuchProviderException,
        ...
        //here we generate key, to generate ke, we need alias.
        //which alias are from cipher.init()

        //which comes from byte[] encryptext(String alias, final Text_ToEncrypt)
